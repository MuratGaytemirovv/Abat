...
class AlphabetAdapter() :
    ListAdapter<Alphabet, AlphabetAdapter.ViewHolder>(AlphabetDiffCallback()) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener() {
            ...
            // Het doel van deze functie is om te bepalen of het id van een letter even is of oneven
            // Als het even is wordt de letter geroteerd
            // Als het oneven is verdwijnt de letter voor een korte periode
    ...
    class ViewHolder private constructor(val binding: LetterItemBinding) :
